...
SET dlurl=https://oss.sonatype.org/service/local/artifact/maven/redirect?r=releases^&g=org.opencds.cqf^&a=tooling-cli^&v=3.5.0^&c=jar-with-dependencies
...
IF /I "%create%"=="Y" (
	ECHO Will place publisher jar here: %input_cache_path%%tooling_jar%
